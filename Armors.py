...
class Armor(Defense, MapObject):
    def __init__(self,player :maze_player,maze: Maze,armor_value:int, image_name: str, passable: bool = True, z_index: int = 0) -> None:
...
class Helmet(Armor):
    ...
    def __init__(self, player: maze_player, maze: Maze, image_name: str, passable: bool = True, z_index: int = 0) -> None:
        ...
        self.pick_text='You picked up the  Chest Helmet! Defense increased by : 10! '
    def player_entered(self, player: maze_player) -> list[Message]:
        super().player_entered(player)
...
class Boots(Armor):
    ...
    def __init__(self, player: maze_player, maze: Maze, image_name: str, passable: bool = True, z_index: int = 0) -> None:
        ...
        self.pick_text='You picked up the  Chest Boots! Defense increased by : 5! '
