...
from .Armors import Defense_type
from .imports import *
if TYPE_CHECKING:
...
class Defense_potion(Potion):
    ...
    def player_entered(self, player: 'maze_player') -> list[Message]:
        ...
        pick_text = 'You picked up the '+ self.__name +'! It is applied to ' + str(armor)+ '.\nDefense increased by ' + str(defense_increase)+'!' 
        self.set_fields()
...
class Attack_potion(Potion):
    ...
    def player_entered(self, player: 'maze_player') -> list[Message]:
        ...
        pick_text = 'You picked up the '+ self.__name +'! It is applied to ' + str(self.__armor)+ '.\nAttack increased by ' + str(attack_increase)+'!'
        self.set_fields() 
        return [DialogueMessage(self, player, pick_text, image_name)]
